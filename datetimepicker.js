...
var initDatetimePicker = function(o){
    $(o).addClass('input-group');
    $(o).addClass('date');
    if($(o).attr('data-link-format') == undefined){
        $(o).attr('data-link-format','yyyy-mm-dd'); //default format
    }
    var h = '<input class=\"form-control\" type=\"text\">'+
